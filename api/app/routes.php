...
$app->post('/getSubjectByUser', 'App\Controllers\SubjectController:getSubjectByUser');
$app->post('/getAllSubject', 'App\Controllers\SubjectController:getAllSubject');
...
$app->get('/send-email', 'App\Controllers\AccountController:sendEmail');
