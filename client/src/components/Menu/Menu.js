    ...
    render() {
        const detail_tt = (
            <div className="ans_quick_link_user">
                ...
                <a type="primary" onClick={this.Logout}> Đăng xuất</a>
            </div>
        )
        var {showhide } = this.state;
        return (
            <div className="header_profile">
                <div className="icon_toggle" onClick={this.show}><i className="glyphicon glyphicon-user"></i></div>
                {showhide? detail_tt:''}
            </div>
            ...
            <div className="menu__left">
                <ul>
                    <li className="list__item">
                        <Link to="/home" title="Home"><i className="fa fa-home"></i></Link>
                    </li>
                    <li className="list__item">
                        <Link to="/login" title="Tài khoản"><i className="fa fa-user"></i></Link>
                    </li>
                </ul>
            </div>
        )
