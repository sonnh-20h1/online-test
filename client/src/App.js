  ...
  RenderMenu = () => {
    return (
      <Switch>
        ...
        <PrivateRoute path="/chu-de-trac-nghiem/:id" component={(match) => <DetailSubject match={match} />} />
        <PrivateRoute path="/chu-de-trac-nghiem" component={() => <Subject />} />
        ...
        <PrivateRoute path="/online-test" component={(location) => <ListQuestion location={location} />} />
      ...
      <div className="test-online">
        ...
        <footer className="footer__test">
          <Container>
            <Row>
              <Col className="">
                <p>Ban biên soạn đề thi: 0123456789. Email hỗ trợ: onlinetest@gmail.com</p>
              </Col>
            </Row>
          </Container>
        </footer>
